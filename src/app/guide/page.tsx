  ...
  return (
    <MainLayout>
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        {/* 使用步驟 */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary-200 mb-6 text-center animate-fade-in">操作步驟</h2>
          <div className="space-y-6">
            {steps.map((step, index) => (
              <Card key={index} className="relative overflow-hidden animate-slide-up">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-gradient-to-br from-primary-700 to-fuchsia-700 text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                        {step.step}
                      </div>
                    </div>
        ...
        {/* 使用技巧 */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary-200 mb-6 text-center animate-fade-in">使用技巧</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {tips.map((tip, index) => (
              <Card key={index} className="h-full animate-slide-up">
                <CardContent className="p-6">
        ...
        {/* 注意事項 */}
        <Card className="bg-amber-900/80 border-amber-700 animate-fade-in">
          <CardContent className="p-6">
        ...
        <div className="mt-8 text-center animate-fade-in">
          <Link
            href="/"
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-700 to-fuchsia-700 text-white rounded-lg hover:scale-105 hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            開始使用
          </Link>
        </div>
